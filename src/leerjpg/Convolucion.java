...
public final class Convolucion extends Component {
    ...
    {
        String path = "C:\\Users\\carlo\\Documents\\NetBeansProjects\\leerjpg\\src\\leerjpg\\gris_img\\animals\\cats";
...
//                        System.out.printf("%11.1f", aux[a][b]);
    ...
    public static double []cnn(double [][]imagenmatrix){
        ...
        double[][]conv1_1 = new double[imagenmatrix.length - kernel_1.length + 1][imagenmatrix.length - kernel_1.length + 1];
        double[][]conv1_2 = new double[imagenmatrix.length - kernel_2.length + 1][imagenmatrix.length - kernel_2.length + 1];
        ...
        /*
        imprimimos las 4 matrices generadas a traves de 2 convoluciones de la imagen inicial
    ...
    File myNewJPegFile = new File(System.getProperty("user.dir")+"\\src\\leerjpg\\gris_img\\images\\"+image_name+".jpg");
